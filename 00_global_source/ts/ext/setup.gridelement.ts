...
tt_content.gridelements_pi1.20.10.setup {
	...
	5 {
		columns {
			# colPos ID
			1 < .default
			1.wrap = <div class="foo foo_1">|</div>
			# colPos ID
			2 < .default
			2.wrap = <div class="foo foo_2">|</div>
			# colPos ID
			3 < .default
			3.wrap = <div class="foo foo_3">|</div>
			# colPos ID
			4 < .default
...
tt_content.gridelements_pi1.20.10.setup {
	...
	6 {
		...
		wrap = <section><div class="dpb horicontal_grid">|</div></section>
	}
}



# Tripple Promotion Box
tt_content.gridelements_pi1.20.10.setup {
	# ID of gridelement
	...
	7 {
		columns {
			# colPos ID
			1 < .default
			1.wrap = <div class="tpb_left tpb span4">|</div>
			# colPos ID
			2 < .default
		...
		wrap = <section><div class="tpb horicontal_grid">|</div></section>
	}
}
...
tt_content.gridelements_pi1.20.10.setup {
	...
	9 {
		columns {
			1 < .default
			1.wrap = <div class="fcg fcg_1 span3">|</div>
			2 < .default
			2.wrap = <div class="fcg fcg_2 span3">|</div>
			3 < .default
			3.wrap = <div class="fcg fcg_3 span3">|</div>
			4 < .default
			4.wrap = <div class="fcg fcg_4 span3">|</div>
		}
		wrap = <section><div class="four_column_grid row-fluid">|</div></section>
	}
}
...
tt_content.gridelements_pi1.20.10.setup {
	# ID of gridelement
	10 < temp.gridelements.defaultGridSetup
	10 {
		columns {
			1 < .default
		...
		wrap = <section><div class="two_col_sized row-fluid">|</div></section>
	}
}
...
tt_content.gridelements_pi1.20.10.setup {
	# ID of gridelement
	11 < temp.gridelements.defaultGridSetup
	11 {
		columns {
			1 < .default
