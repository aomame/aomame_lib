#--------------------------------------------------------
#
#  RTE Settings by George Ringer
#  Project: modernpackage
#  Git: https://github.com/georgringer/modernpackage.git
#  File: https://github.com/georgringer/modernpackage/blob/master/Resources/Private/TsConfig/Page/rte/default.ts
#
#--------------------------------------------------------
