...
<INCLUDE_TYPOSCRIPT: source="FILE: typo3conf/ext/aomame/template/aomame/main_template/ts/page/setup.additional_files.ts">
...
## EXT TS
<INCLUDE_TYPOSCRIPT: source="FILE: typo3conf/ext/aomame/template/00_global_source/ts/ext/setup.perfectlightbox.ts">
<INCLUDE_TYPOSCRIPT: source="FILE: typo3conf/ext/aomame/template/aomame/main_template/ts/ext/setup.formhandler.ts">
<INCLUDE_TYPOSCRIPT: source="FILE: typo3conf/ext/aomame/template/00_global_source/ts/ext/setup.scriptmerge.ts">
<INCLUDE_TYPOSCRIPT: source="FILE: typo3conf/ext/aomame/template/00_global_source/ts/ext/setup.gridelement.ts">
