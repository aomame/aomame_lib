...
aomame {
	...
	path {
		...
		maintemplate = typo3conf/ext/aomame/template/easy_aomame_ch/main_template/
		# cat=Aomame: Path/path/02; type=string; label= Path to extension template folder
		exttemplate = typo3conf/ext/aomame/template/easy_aomame_ch/ext_template/
		# cat=Aomame: Path/path/03; type=string; label= Path to TS files
		ts = typo3conf/ext/aomame/template/easy_aomame_ch/main_template/ts/
		# cat=Aomame: Path/path/04; type=string; label= Path to HTML files
		html = typo3conf/ext/aomame/template/easy_aomame_ch/main_template/html/
		# cat=Aomame: Path/path/05; type=string; label= Path to CSS files
		css = typo3conf/ext/aomame/template/easy_aomame_ch/main_template/css/
		# cat=Aomame: Path/path/06; type=string; label= Path to Bootstrap files
		bootstrap = typo3conf/ext/aomame/template/easy_aomame_ch/main_template/bootstrap/
		# cat=Aomame: Path/path/07; type=string; label= Path to JavaScript files
		js = typo3conf/ext/aomame/template/easy_aomame_ch/main_template/js/
		# cat=Aomame: Path/path/08; type=string; label= Path to image folder
		image = typo3conf/ext/aomame/template/easy_aomame_ch/main_template/img/
		#images of bootstrap framework
		bootstrap.img = typo3conf/ext/aomame/template/easy_aomame_ch/main_template/img/bootstrap/
